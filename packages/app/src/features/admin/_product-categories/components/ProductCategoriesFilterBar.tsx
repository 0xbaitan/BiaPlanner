...
export default function ProductCategoriesFilterBar() {
  const { setSortBy, setFilter } = useProductCategoriesCrudListActions();
  ...
  return (
    <FilterBar>
      ...
      <FilterBar.Group type="prominent-filters">
        <FilterBar.OrdinarySelect label="Allergen visibility" value={productCategoriesQuery.allergenVisibility} onChange={(e) => setFilter({ allergenVisibility: e.target.value as ProductCategoryAllergenFilter })}>
