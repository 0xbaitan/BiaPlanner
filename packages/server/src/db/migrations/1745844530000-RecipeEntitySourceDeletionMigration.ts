...
export class RecipeEntitySourceDeletionMigration1745844530000 implements MigrationInterface {
    name = 'RecipeEntitySourceDeletionMigration1745844530000'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE FULLTEXT INDEX \`product_full_text_fields_idx\` ON \`products\` (\`name\`, \`description\`)`);
        await queryRunner.query(`ALTER TABLE \`recipes\` ADD \`instructions\` text NOT NULL`);
