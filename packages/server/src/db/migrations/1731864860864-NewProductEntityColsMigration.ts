...
export class NewProductEntityColsMigration1731864860864 implements MigrationInterface {
    name = 'NewProductEntityColsMigration1731864860864'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`canExpire\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`products\` ADD \`isLoose\` tinyint NOT NULL DEFAULT 0`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`isLoose\``);
        await queryRunner.query(`ALTER TABLE \`products\` DROP COLUMN \`canExpire\``);
    }
